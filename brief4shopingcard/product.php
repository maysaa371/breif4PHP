         ...
         <div class="container">
            <div>
               <div class="category-buttons option" style="display: flex;">
                  ...
                  <button class="option2" data-category="clothing" style="width: 10%;color:black;background-color:white"><a href="cat-2.php">SunGlasses</a></button>
                  <button class="option2" data-category="shoes" style="width: 10%;color:black;background-color:white"><a href="cat-1.php">Ring</a></button>
